        ...
        <div className="grid md:grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <motion.div
              ...
              className="bg-[#e0f0ff] rounded-2xl p-5 flex flex-col min-h-[180px]"
            >
              <div className="mb-3">
            ...
            <motion.div
              ...
              className="bg-[#e0d8f4] rounded-2xl p-5 flex flex-col relative overflow-hidden flex-1 min-h-[220px]"
            >
              <div className="mb-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <motion.div
              ...
              className="relative rounded-2xl overflow-hidden flex-1 min-h-[220px]"
            >
              <img 
            ...
            <motion.div
              ...
              className="bg-[#fff8dc] rounded-2xl p-5 flex flex-col min-h-[180px]"
            >
              <div className="mb-3">
